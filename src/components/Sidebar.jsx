...
const Sidebar = () => {
  ...
  return (
    <div>
      <nav className=" w-full h-full border-r bg-white drop-shadow-lg space-y-8 sm:w-80">
                ...
                {isProfileActive ? (
                  <div className="absolute z-10 top-12 right-0 w-64 rounded-lg bg-white shadow-md border text-sm text-gray-600">
                    <div className="p-2 text-left">
                      ...
                      <button className="block m-auto p-2 text-center bg-gray-100 rounded-md hover:bg-gray-300 hover:underline hover:text-[--primary] active:bg-gray-400 duration-150">
                        Logout
                      </button>
                    </div>
                  </div>
